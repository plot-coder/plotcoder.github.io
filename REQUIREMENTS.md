...
- **As built:**
  ...
  - **The agent door does not change.** The MCP server still talks to the open app through the bridge. A remote agent with a service key is a later item, on purpose.
...
- **Slice c, as built (2026-09-13; the standard drawn on a page, three homes mocked, asked, built in four pieces):**
  ...
  - **Honest limits:** the reader was tested against a file written by hand in Final Draft's shape and against this app's own writer, not yet against a file Final Draft itself wrote; the page on screen is read, and editing happens as text — the page as the editor is the next step; scene numbers are computed and not locked (question 23); no A/B pages or revision colours. Forty-six tools.
