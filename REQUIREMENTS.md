...
- **Status:** confirmed; **slices a and b built** 2026-09-13 (Fountain out; pages beside the wall), slice c open
...
- **Slice b, as built (2026-09-13; mocked three homes, asked, revised, built):**
  ...
  - **Not in this slice:** pagination, `(MORE)` and `(CONT'D)`, dual dialogue, scene numbers — slice c, the standards problem.
