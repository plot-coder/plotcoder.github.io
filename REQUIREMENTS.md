...
| 5. Pages | R23 | **built** — Fountain out and in, a scene's text on its card, pages beside the wall, pagination to the industry's rules, Final Draft out and in | `export_fountain`, `read_pages`, `write_scene`, `import_fountain`, `page_count`, `export_fdx`, `import_fdx` |
