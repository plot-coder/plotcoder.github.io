...
- **Not yet:** the *structural* checks the statement names — a character who disappears, a setup with no payoff — still need characters (P15) and typed arrows (P16). The board cannot read what it does not hold.
...
| 4. Read the wall | R22 | **first slice built** — runs between beats and five kinds of question; characters and typed arrows still to come | `read_wall` |
...
| Navigator — filter the story by character or location | None | Characters on cards first (P15, open question 17), then location |
| Reports — scenes, characters, locations | `list_board` summary | Reports over cards once cards carry characters and locations |
...
- No tool to start a **new board** or clear one; an agent inherits whatever the file holds.
