...
- **Notes:** A board cannot yet move between projects, and there is one project per browser; both wait for Supabase, where a project becomes a row and a writer can have several.
...
| More than one script per writer | **Built** (R35): a project of boards, in order, under one premise; one project per browser until Supabase | Several projects per writer, with Supabase |
