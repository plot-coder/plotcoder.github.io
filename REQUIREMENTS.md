...
- **Since then:** the cast (R29) added "a character who disappears" and "a person on no card". Typed arrows (R30) added the setups reading and "a payoff before its setup". **Still not yet:** a setup with **no** payoff — see R30 for why an arrow alone cannot say it, and open question 27.
...
| 4. Read the wall | R22 | **built in three slices** — runs between beats, setups and payoffs, eight kinds of question. Left: a setup with no payoff (question 27) | `read_wall` |
...
27. How does a writer mark a **setup that has no payoff yet** (R22, R30)? A typed arrow needs two ends. Candidates: a mark on the card ("plants"), or an arrow drawn to nothing that renders as a stub. Mock both before choosing; the check "a setup with no payoff" waits on it.
