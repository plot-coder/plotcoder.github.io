...
### R39 — The name on the door

- **Status:** **built** 2026-09-13 (mocked three doors, then two shapes; asked twice; revised; built)
- **Date:** 2026-09-13
- **Statement:** A writer signs in with a **name and a password**. The password has **no rules**: anything, any length. A new name is claimed the moment its password is set. Nothing else is asked at the door.
...
- **As built:**
  ...
  - **Not built:** a way back from a forgotten password. The door says so. An optional email for a reset by magic link is the plan when it is wanted.
