# The blind-run prompt — round twenty-four, as it ran (2026-09-21): what the door says before anything is read, and an undo through it
...
The notes are `round-twenty-four-idea.md`, not copied here: one treatment, one file.
