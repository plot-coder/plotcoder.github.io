...
3. list_workflows — what a writer can ask you for — and, in its first workflow, what a treatment should answer: the questions to put to the writer before you build, each with the tool its answer lands in.
