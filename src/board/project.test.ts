...
describe("one cast for the project (R51)", () => {
  ...
  const card = (id: string, characterIds: string[]) => ({
    id, headline: id, change: "Turns.", color: "yellow" as const, x: 0, y: 0, rotate: 0, z: 1, rank: "scene" as const, lengthEighths: null, characterIds, plants: false, plantsWhat: "", alternativeOf: null, payoffBoardId: null, payoffNoteId: null, open: "", location: "", locationOpen: "", when: "", whenOpen: "", text: "", createdAt: NOW, updatedAt: NOW,
  });
