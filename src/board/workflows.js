...
export const WORKFLOWS = [
  {
    ...
    needs: [
      ...
      { question: "What is the central question, in one sentence?", hint: "The premise is what is true before the film starts, and any rule the whole film keeps — \"nobody says the word sell to her face until the end\" is a premise line; if this is one episode of something, what the series is about. Not decided: either takes open with the writer's words, and the reading lists it.", tool: "set_logline, set_premise" },
